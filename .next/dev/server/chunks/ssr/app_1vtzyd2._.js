...
async function __TURBOPACK__default__export__(props) {
    ...
    function getImageMetadata(imageMetadata, idParam) {
        const data = {
            ...
            url: imageUrl + (idParam ? '/' + idParam : '') + '?' + "3d6ac336880f9e6a"
        };
...
const MARK_PATH = "m870.67,7.78H7.5v299.6h761.99v32.54H7.5v458.55h359.42v-152.87h503.75c113.41,0,205.34-79.53,205.34-177.63V185.41c0-98.1-91.93-177.63-205.34-177.63Z";
